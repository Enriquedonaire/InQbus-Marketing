    ...
    <div className="max-w-3xl mx-auto">
      {isSubmitted ? (
        ...
        >
          ...
          <h3 className={`text-2xl font-bold ${isDark ? "text-white" : "text-blue-900"} mb-2`}>¡Mensaje Enviado!</h3>
        ...
        >
          ...
          <div className="space-y-2 mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {["SEO", "Marketing Digital", "Diseño Web", "Redes Sociales", "Contenido", "Analítica"].map((service) => (
                <div key={service} className="flex items-center space-x-2">
                  <input
                    ...
                    value={service}
                    className={`rounded ${
                      isDark ? "border-white/20 bg-black/30 text-blue-500" : "border-gray-300 bg-white/50 text-blue-600"
                    } focus:ring-blue-500`}
                  />
