  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        // Crear una sesión en Supabase (usando autenticación anónima)
        const { data, error } = await supabase.auth.signInWithPassword({
          email: role === "admin" ? "admin@inqubus.com" : "recruiter@inqubus.com",
          password: password,
        })

        if (error) {
          // Si hay error con Supabase, usar localStorage como fallback
